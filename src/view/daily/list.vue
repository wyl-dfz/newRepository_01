    ...
    methods: {
      ...
      exportDaily() {
        ...
        if (dailyDate.length > 0) {
          dailyDate = dailyDate.substring(0, 4) + '-' + dailyDate.substring(4, 6) + '-' + dailyDate.substring(6, 8);
          window.location.href = window.baseUrl + 'daily/exportDaily?day=' + dailyDate;
        } else {
